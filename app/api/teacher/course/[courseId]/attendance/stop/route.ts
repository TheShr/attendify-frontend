...
export async function POST(
  ...
  try {
    ...
    const backendUrl = buildBackendUrl(params.courseId, '/attendance/stop')
    console.log(`[Teacher Attendance Stop Proxy] POST ${backendUrl}`)
    ...
    console.error('Teacher attendance stop proxy error:', error)
